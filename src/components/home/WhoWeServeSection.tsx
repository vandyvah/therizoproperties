  ...
  return <section className="section-padding bg-background">
      <div className="container-wide">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">Therizo works with clients who want more than glossy photos and empty promises. If you care about title, numbers, and long-term value, we are built for you.</p>
        </div>

        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-12">
          {audiences.map(item => <div key={item.title} className="group p-4 sm:p-6 bg-card rounded-lg border border-border hover:border-gold/50 hover:shadow-therizo-md transition-all duration-300">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gold/10 flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-gold/20 transition-colors">
