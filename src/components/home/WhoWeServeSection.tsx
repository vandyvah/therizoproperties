  ...
  return <section className="section-padding bg-background">
      <div className="container-wide">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {audiences.map(item => <div key={item.title} className="group p-6 bg-card rounded-lg border border-border hover:border-gold/50 hover:shadow-therizo-md transition-all duration-300">
