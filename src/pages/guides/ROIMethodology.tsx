  ...
  return (
    <Layout>
      <SEOHead
        ...
        pinterestImage="https://therizoproperties.com/pinterest/pin-roi-methodology.jpg"
      />
      ...
      <JsonLd data={createBreadcrumbSchema([
        ...
        { name: "ROI Methodology", url: "https://therizoproperties.com/guides/roi-methodology" },
      ])} />
